--- STEAMODDED HEADER
--- MOD_NAME: miniBalatro
--- MOD_ID: miniCards
--- MOD_AUTHOR: [Ness]
--- MOD_DESCRIPTION: An average sized overhaul of Balatro's textures.

----------------------------------------------
------------MOD CODE -------------------------

function SMODS.INIT.shrimpleCards()
    sendDebugMessage("no need for debug messages where i'm from")

    local tpt_mod = SMODS.findModByID("miniCards")
...
--    local sprite_tags = SMODS.Sprite:new("tags", tpt_mod.path, "tags.png", 34, 34, "asset_atli")
 --   local sprite_tarots = SMODS.Sprite:new("Tarots", tpt_mod.path, "Tarots.png", 71, 95, "asset_atli")
